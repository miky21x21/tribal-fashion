...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        "tribal-striped":
          "linear-gradient(to bottom, #fce29c 0%, #fce29c 14%, #000000 14%, #000000 20%, #fce29c 20%, #fce29c 27%, #9d2320 27%, #9d2320 31%, #ffffff 31%, #ffffff 69%, #9d2320 69%, #9d2320 73%, #fce29c 73%, #fce29c 80%, #000000 80%, #000000 86%, #fce29c 86%, #fce29c 100%)",
